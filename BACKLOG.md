...
| D | Acts II–III: data center, underground, Dad on the USB, contradictions | 0.10–0.15 | 🚧 in progress — D0 v0.10.0, D1 v0.11.0, D2 v0.12.0 (Dad, the censor, poker, Nolan); plan: `docs/superpowers/specs/2026-09-07-stage-d-plan.md`; D3 (the facility surface) next, prose reviewed |
