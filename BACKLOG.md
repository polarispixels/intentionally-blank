...
| D | Acts II–III: data center, underground, Dad on the USB, contradictions | 0.10–0.15 | 🚧 in progress — D0 v0.10.0, D1 v0.11.0 (the ride, Wall Drug, the cache, the notebook); plan: `docs/superpowers/specs/2026-09-07-stage-d-plan.md`; D2 (Dad, the censor, poker) next, prose reviewed; D3 prose written |
...
| # | Remaining | Type |
|---|---|---|
| D2–D5 | The town in daylight (Dad, censor, poker — prose reviewed, `2026-09-10-stage-d2-prose.md`); the facility surface (prose written, `2026-09-11-stage-d3-prose.md`); the descent; Sublevel 6 | Content |
