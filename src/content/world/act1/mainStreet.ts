...
import { ACT1_MAIN_STREET_BOUNDARY_NORTH, ACT1_MAIN_STREET_BOUNDARY_SOUTH, ACT1_MAIN_STREET_BOUNDARY_WEST } from './responses';
import { MAIN_STREET_TO_FRONT_DESK_TEXT } from './objects/mainStreet';
import { FLAG_VISITED_MAIN_STREET, FRONT_DESK, MAIN_STREET, MAIN_STREET_BOUNDARY_GATE, V_LOOK_UP } from './ids';
...
const RETURN_VISIT =
  'The street, both ways, empty. The horses at their rail across the road. One lamp lit four buildings down, a man still under it. North, past the roofs, the same light on the same horizon. The boarding house door is behind you.';
...
export const mainStreetRoom: RoomDefSlice = {
  ...
  exits: [
    ...
    // §8's build boundary — always-closed gate, `to: MAIN_STREET` (self, never actually reached — same idiom as the front desk's own former boundary).
    { dir: 'n', to: MAIN_STREET, door: MAIN_STREET_BOUNDARY_GATE, blockedText: { ref: ACT1_MAIN_STREET_BOUNDARY_NORTH } },
    { dir: 's', to: MAIN_STREET, door: MAIN_STREET_BOUNDARY_GATE, blockedText: { ref: ACT1_MAIN_STREET_BOUNDARY_SOUTH } },
    { dir: 'w', to: MAIN_STREET, door: MAIN_STREET_BOUNDARY_GATE, blockedText: { ref: ACT1_MAIN_STREET_BOUNDARY_WEST } },
  ],
