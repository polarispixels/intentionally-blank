...
export const ACT1_QUESTIONS: NonNullable<WorldDef['questions']> = {
  ...
  [QUESTION_NOTEBOOK]: {
    ...
    answer: 'In a claim box at Wall Drug, on a hold under a numbering scheme the counter stopped using before the present clerk started — where nothing is indexed, and nobody currently living had any reason to look it up.\n\nAnd the other party had already been through my room before I woke up in it: unhurried, quiet, wiping his feet on the way in, and taking nothing at all, which is what a man does when the one thing worth taking is the one thing that is not there.',
  },
  [QUESTION_WALL_DRUG]: {
    ...
    answerWhen: { flag: ACT2_CACHE_FOUND },
    answer: 'Free ice water, as advertised. A woman at the counter who remembers a grey hat and can tell you nothing whatsoever about the face under it. And behind her, in a corridor of shelving run on a scheme nobody currently working there was ever taught: bay E, and a box on a hold that nobody had asked after in months.\n\nA hard-backed notebook with a pencil under a dead rubber band. A memory stick labelled by hand. A canister of exposed film with nothing written on it. And a letter that was sent, refused, and kept anyway.',
  },
};
