...
export const PHOTOGRAPH_TEXT = 'You have no camera. You have a hat, a chair leg and a notebook, and the\nnotebook is the one that has ever proved anything.';
...
const paperbackText = 'Face down, spine broken, about a third of the way through. Kept by the reader\nin the crudest way there is, which means somebody meant to come back to it.';
