...
export const RESPONSES = {
  ...
  'conversation.noTopic': [
    'You get as far as "About the—" and stop, not having settled what about. {name} waits it out.',
